...
public:
  ...
  tlm_utils::simple_target_socket<interconnect> ic_cpu_tsoc1;
  tlm_utils::simple_target_socket<interconnect> ic_cpu_tsoc2;
  tlm_utils::simple_initiator_socket<interconnect> ic_cpu_isoc;
    
  tlm_utils::simple_target_socket<interconnect> ic_hard_tsoc;
  tlm_utils::simple_initiator_socket<interconnect> ic_hard_isoc;
